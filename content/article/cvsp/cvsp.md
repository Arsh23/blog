...
date: "2018-02-08"
description: test desc this is a test
url: /cvsp/
includeD3: true
...
*code used to produce this output can be found [here](https://github.com/Arsh23/cvsp/blob/master/fib.py)*
{{% /text %}}{{% /center %}}
...
```
{{% center %}}{{% text s="0.8" color="#808080" %}}
*code used to produce this output can be found [here](https://github.com/Arsh23/cvsp/blob/master/download.py)*
{{% /text %}}{{% /center %}}
...
{{% inline-block 60 %}}Firstly, you have to **load** the pixel's data. This can represent loading the pixel from memory, sending a http request for the pixel's data or any number of other things. But what this step mainly depicts is something that takes a long time(relative to rest of the code) to process while the code is waiting for it to finish before continuing.{{% /inline-block %}}
